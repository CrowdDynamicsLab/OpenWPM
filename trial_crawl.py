...
if __name__ == "__main__":
    ...
    for sub in subs:
        for i in range(3):
            manager_params, browser_params = TaskManager.load_default_params(NUM_BROWSERS)
            dir = sub+'_'+str(i)
            if dir not in os.listdir('/home/nick/Development/crawl_data/'):
                os.mkdir('/home/nick/Development/crawl_data/' + dir)
            manager_params['data_directory'] = '/home/nick/Development/crawl_data/'+dir
            manager_params['log_directory'] = '/home/nick/Development/crawl_data/'+dir
